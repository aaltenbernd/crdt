...
urlpatterns = [
    ...
    url(r'^show_messages/(?P<active_folder_id>inbox|outbox)/(?P<mark>readed|unreaded)/$', views.show_messages, name='show_messages'),
    url(r'^show_messages/(?P<active_folder_id>[-\w]+)/(?P<mark>readed|unreaded)/$', views.show_messages, name='show_messages'),
